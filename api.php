...
namespace Tqdev\PhpCrudApi {
    ...
    // ========================================================================
    // KICKBACK – Datenbank-Zugangsdaten fuer Plesk
    // >>> Diese Werte AUF DEM PLESK-SERVER eintragen.
    //     NICHT mit echten Passwoertern ins oeffentliche GitHub pushen! <<<
    // ========================================================================
    $config = new Config([
        'driver'   => 'mysql',
        'address'  => 'localhost',          // auf Plesk meist 'localhost'
        'port'     => '3306',
